...
virtual_geometries = [g for g in os.listdir("geometries") if g.startswith("virtual")]
virtual_geometries.sort(reverse=True)
...
virtual_transversal_traces = [Transversal(*tr_args, g) for g in virtual_geometries]
...
if __name__ == "__main__":
    ...
    for i in virtual_transversal_traces:
        run_vtk_obj_heat(i)
