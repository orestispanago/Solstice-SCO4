...
# plot_calendar_heatmap(annual_df, "absorbed_flux", folder=annual.plots_dir, units=" (W)")
# plot_calendar_heatmap(annual_df, "missing_losses", folder=annual.plots_dir, units=" (W)")
# plot_calendar_heatmap(annual_df, "shadow_losses", folder=annual.plots_dir, units=" (W)")
